...
public class VentanaConvertidorPeso extends JFrame implements ActionListener{
	...
	private void iniciarComponentes() {
		...
		btnCancelarConvertidor.setBackground(new Color(191, 255, 194));
